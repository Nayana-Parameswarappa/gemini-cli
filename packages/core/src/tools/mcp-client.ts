...
function toMcpContext(
  cliConfigOrSanitizationConfig: McpContext | EnvironmentSanitizationConfig,
): McpContext {
  return 'sanitizationConfig' in cliConfigOrSanitizationConfig
    ? cliConfigOrSanitizationConfig
    : {
        sanitizationConfig: cliConfigOrSanitizationConfig,
        emitMcpDiagnostic: () => {},
...
export async function connectToMcpServer(
  ...
  const cliConfig = toMcpContext(cliConfigOrSanitizationConfig);
  const sanitizationConfig = cliConfig.sanitizationConfig;
